          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-lg text-textLight mb-4">
                Selamat datang kembali di order page Skill Connect.
              </p>
              <p className="text-lg text-textLight">
                Ruang Kerja Anda siap. Mari segera wujudkan ide luar biasa Anda hari ini.
              </p>
            </div>
            
            <div className="hidden lg:block flex-1 ml-8">
              <div className="relative">
                <div className="w-64 h-64 bg-white rounded-full opacity-20"></div>
                <div className="w-48 h-48 bg-white rounded-full opacity-30 absolute top-8 left-8"></div>
                <div className="w-32 h-32 bg-white rounded-full opacity-40 absolute top-16 left-16"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-secondary py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-title font-bold text-text mb-4">
              Layanan
            </h2>
            <p className="text-lg text-textMuted">
              Temukan layanan profesional yang sesuai dengan kebutuhan Anda
            </p>
          </div>
      ...
      <footer className="bg-secondary py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-200 mt-8 pt-8 text-center">
            <p className="text-textMuted">© SkillConnect.</p>
          </div>
        </div>
      </footer>
    </div>
