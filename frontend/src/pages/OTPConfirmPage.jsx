...
export default function OTPConfirmPage() {
  ...
  const footer = (
    <div className="mt-6 text-center">
      <button onClick={() => navigate("/forgot-password")} className="text-[#3A2B2A] underline hover:no-underline">
      ...
      <div className="w-full max-w-md">
        <ResetPasswordCard title="Kode OTP" hasHeader={true}>
          ...
          <form onSubmit={handleSubmit}>
            <ResetPasswordFormGroup label="Kode OTP" name="otp" type="text" placeholder="Masukkan kode OTP" value={otp} onChange={(e) => setOtp(e.target.value)} error={error} />
