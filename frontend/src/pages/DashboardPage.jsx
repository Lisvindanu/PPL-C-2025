...
import { useState } from 'react' // BARIS BARU: Impor useState
import Navbar from '../components/organisms/Navbar'
import ReviewModal from '../components/organisms/ReviewModal' // BARIS BARU: Impor ReviewModal

export default function DashboardPage() {
  const user = typeof window !== 'undefined' ? JSON.parse(localStorage.getItem('user') || 'null') : null

  // BARIS BARU: State untuk mengontrol modal
  const [isReviewModalOpen, setReviewModalOpen] = useState(false);

  // BARIS BARU: Fungsi untuk menutup modal
...
          </p>
          
          {/* BARIS BARU: Tombol untuk testing modal */}
          <button
            onClick={() => setReviewModalOpen(true)}
            className="mb-8 bg-blue-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700"
          >
            Buka Review Modal (Testing)
          </button>
...
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                nbsp;   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                  </svg>
                </div>
...
      </div>
      
      {/* BARIS BARU: Tampilkan modal jika 'isReviewModalOpen' true */}
