    ...
    return (
      <AuthLayout>
        <div className="w-full max-w-4xl text-center">
          <h2 className="text-[#1D375B] text-3xl mb-8 font-medium font-title">Bergabung sebagai klien atau pekerja lepas</h2>
    ...
    <AuthLayout
      ...
      bottom={(
        <div className="w-full max-w-xl text-right text-[#1D375B]">
          Mencari pekerjaan? <Link to="/register/freelancer" className="text-[#4782BE] font-semibold underline hover:text-[#1D375B]">Bergabung sebagai Freelancer</Link>
        </div>
      )}
    >
