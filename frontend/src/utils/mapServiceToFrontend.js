...
export const mapServiceDetailToFrontend = (backendService) => {
  ...
  return {
    ...
    price: parseFloat(backendService.harga ?? backendService.price ?? 0),
    ...
    rating: parseFloat(backendService.rating_rata_rata ?? backendService.rating ?? 0),
    reviews: parseInt(backendService.jumlah_rating ?? backendService.jumlah_review ?? backendService.reviews ?? 0),
    orders: parseInt(backendService.total_pesanan ?? backendService.orders ?? 0),
