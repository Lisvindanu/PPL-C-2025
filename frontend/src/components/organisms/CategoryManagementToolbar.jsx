  ...
  return (
    <div className="p-6 border-b border-[#D8E3F3]">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 flex-1">
          ...
          <select
            ...
            className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4782BE] focus:border-transparent bg-white"
          >
      ...
      <div className="text-sm text-gray-600">
        Menampilkan <span className="font-semibold text-gray-900">{displayedCategories}</span> dari{' '}
        <span className="font-semibold text-gray-900">{totalCategories}</span> kategori
      </div>
    </div>
  );
}