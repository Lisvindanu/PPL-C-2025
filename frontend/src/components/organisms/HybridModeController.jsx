      ...
      {showController && (
        <div className="absolute top-12 right-0 bg-white border border-gray-200 rounded-lg shadow-lg p-4 w-80">
            ...
            <ul className="text-xs text-gray-500 space-y-1">
              {isMockMode ? (
                <>
                  ...
                  <li>• <strong>Database TIDAK terupdate</strong></li>
                </>
              ) : (
                <>
                  ...
                  <li>• <strong>Database TERUPDATE</strong></li>
                </>
              )}
            </ul>
          </div>
          ...
          <div className="space-y-2">
            <button
              onClick={clearData}
              className="w-full px-3 py-2 bg-red-100 text-red-800 text-xs rounded hover:bg-red-200 transition-colors"
            >
              Clear Mock Data
            </button>
          ...
          <div className="mt-4 pt-3 border-t border-gray-200">
            <p className="text-xs text-gray-500">
              ...
              • Mock Mode: Test UI tanpa backend<br/>
              • Real API Mode: Test dengan database<br/>
              • Toggle mode kapan saja untuk testing
            </p>
          </div>
        </div>
      )}
