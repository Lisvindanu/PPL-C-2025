...
export default function AddServiceCallout() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4">
      <button
        type="button"
        onClick={() => navigate("/freelance/create-service")}
      ...
      >
        <div className="flex flex-col items-center gap-3">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#C7CFB0]/30 text-[#8DA05A]">
            <Icon name="plus" className="h-6 w-6" />
          </div>
          <p className="text-2xl font-semibold text-[#8DA05A]">
            Tambah Layanan Baru
          </p>
        </div>
      </button>
