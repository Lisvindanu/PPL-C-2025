export default function RestoreRecommendationModal({ isOpen, onClose, onConfirm, serviceName }) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 animate-fadeIn">
        ...
        <div className="flex justify-center mb-4">
          <div className="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center">
            <i className="fas fa-eye text-3xl text-[#4782BE]"></i>
          </div>
        </div>

        {/* Title */}
        <h3 className="text-xl font-bold text-neutral-900 text-center mb-2">
          Tampilkan Kembali Rekomendasi?
        </h3>

        {/* Description */}
        <p className="text-neutral-600 text-center mb-6">
          Rekomendasi <span className="font-semibold text-neutral-900">"{serviceName}"</span> akan ditampilkan kembali di beranda Anda.
        </p>
